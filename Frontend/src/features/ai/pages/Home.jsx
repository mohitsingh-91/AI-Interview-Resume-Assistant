...
const Home = () => {
    ...
    return (
        ...
        <header className='page-header'>
            <h1>Build Your <span className='highlight'>Interview Playbook</span></h1>
            <p>Let our AI analyze the job requirements and your unique profile to build your winning playbook</p>
        </header>
